...
<?php
  ...
  ?>
  <li>
      <a class="btn btn-outline-secondary" href="../../1/<?php echo $comments_reported_current_page -1 ; ?>/#tomoderate" aria-label="Previous">
  ...
  ?>
  <li>
      <a class="btn btn-outline-secondary" href="../../1/<?php echo $comments_reported_current_page + 1; ?>/#tomoderate" aria-label="Next">
