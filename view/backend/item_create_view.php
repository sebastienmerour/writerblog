...
?>
<?php $title = "Ajout d'un nouvel article"; ?>
<?php ob_start(); ?>
...
<div class="card my-4">
  <h5 class="card-header">Ajout d'un nouvel article</h5>
    <div class="card-body">
      <form action="<?php echo BASE_URL; ?>writeradmin/index.php?action=createitem" method="post" enctype="multipart/form-data">
        <div class="form-group">
          <input class="form-control" id="title" name="title" type="text" placeholder="Titre"><br>
              ...
              <textarea class="form-control" id="content" name="content" rows="6" placeholder="Ecrivez ici votre article"></textarea>
							...
							<a href="<?php echo BASE_URL; ?>writeradmin/index.php" role="button" class="btn btn-md btn-primary">Retour</a>
      </form>
    </div>
</div>
