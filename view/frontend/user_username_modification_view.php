...
<?php ob_start();?>
        ...
        <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="infos" role="tabpanel" aria-labelledby="pills-profile-tab">
      ...
      <div class="tab-pane fade" id="username" role="tabpanel" aria-labelledby="pills-profile-tab">
        ...
        <form role="form" class="form needs-validation" action="?action=updateusername" method="post" id="usermodification" novalidate>
          <p>&nbsp;</p>
					<?php
